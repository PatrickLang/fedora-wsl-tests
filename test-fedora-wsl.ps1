...
$url = 'https://artifacts.dev.testing-farm.io/5db2ed75-791d-4ce7-b6a9-afba4145a861/work-build1cidpheh/tmt/plans/wsl/build/execute/data/guest/default-0/tmt/tests/build-image-1/data/Fedora-WSL-Base-Rawhide.20250117.1922.aarch64.tar.xz'
# Globals
